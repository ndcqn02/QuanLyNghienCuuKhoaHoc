 ...
 */
public class UpdateDeTai extends javax.swing.JFrame {
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        try {
            Connection connection = DBConnection.getConnection();
             String sql = "update DeTai set IdDeTai = ?, tenDeTai = ?, tenChuNhiem = ?, soLuong = ?, TrangThai =? "
                    + " where IdDeTai = ?";
            ...
            ps.setString(6,jtfIDDeTai.getText());
            ps.executeUpdate();
           // ps.execute();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateDeTai.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UpdateDeTai().setVisible(true);
            }
        });
    }
