...
public class Home extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Nhập tên đề tài muốn tìm: ");
        ...
        jPanel2.setBackground(new java.awt.Color(161, 227, 216));
        ...
        jPanel4.setBackground(new java.awt.Color(247, 255, 147));

        jLabel2.setBackground(new java.awt.Color(247, 255, 147));
    ...
    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaActionPerformed
        ...
        if (result == 0) {
            try {
                ...
                String sql = "DELETE FROM dbo.[DeTai] WHERE  IdDeTai= ?";
    ...
    private void jLabel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MouseClicked
        // TODO add your handling code here:
        Home_QuanLyNKH q1 = new Home_QuanLyNKH();
        q1.setVisible(true);
        this.dispose();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            tableMain.removeAll();
            String[] arr = {"ID đề tài", "Tên đề tài", "Tên Chủ Nhiệm", "Số lượng NHK", "Trạng thái"};
            DefaultTableModel model = new DefaultTableModel(arr, 0);

            java.sql.Connection connection = DBConnection.getConnection();

            String sql = "SELECT * FROM DeTai where tenDeTai like ?";
            ...
            while (rs.next()) {
                ...
                vector.add(rs.getString("IdDeTai"));
                vector.add(rs.getString("tenDeTai"));
                vector.add(rs.getString("tenChuNhiem"));
